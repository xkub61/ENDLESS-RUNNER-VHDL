...
vlib work
vcom -explicit  -93 "lcd_driver.vhd"
vcom -explicit  -93 "tb_lcd_driver.vhd"
vsim -t 1ns   -lib work tb_lcd_driver
add wave sim:/tb_lcd_driver/*
add wave -position end  sim:/tb_lcd_driver/instance_lcd_driver/controladora/atual_estado
add wave -position end  sim:/tb_lcd_driver/instance_lcd_driver/controladora/prox_estado
#do {wave.do}
view wave
view structure
view signals
